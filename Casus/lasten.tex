...
\subsection{Versnelling}
    Hier wordt het koppeloverschot berekent wat nodig is om de beoogde versnelling te behalen voor het wiel. 
    ...
    \begin{multicols}{2}
        ...
        \begin{equation}
            \begin{split}
                ...
                &= 9.36 [rad/s^2] \\
                &\Downarrow \\
                T_{acc wiel} &= 2.1 \cdot 10^{-3} \cdot 9.36 = 19.6 [mNm]\\
            \end{split}
        \end{equation}
...
Nu berekenen we het voor het hele karretje.
    ...
    \begin{multicols}{2}
        ...
        \begin{equation}
            \begin{split}
                ...
                T &= F \cdot r \\
                &\Downarrow \\
                T &= 2.1 \cdot 10^{-3} \cdot 9.36 = 19.6 [mNm]
            \end{split}
        \end{equation}
